...
exports.expressConfigure = async function (hookName, context) {
    ...
    // for uploaded image
    context.app.get('/p/getUserImage/:padId/:mediaId/:userId', function (req, res, next) {
        var s3  = new AWS.S3({
    ...
    context.app.post('/p/:padId/pluginfw/ep_profile_modal/upload/:userId', function (req, res, next) {
