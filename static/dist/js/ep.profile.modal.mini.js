      ...
      $.ajax({
        ...
        beforeSend: () => {
          ...
          $('#ep_profile_users_profile_userImage')
              .css({'background-position': '50% 50%', 'background-image': `url(${imageUrl})`, 'background-repeat': 'no-repeat', 'background-size': '69px'});// , 'background-color': '#3873E0'
        ...
        success: (response) => {
          ...
          $('#ep_profile_users_profile_userImage').css({'background-position': '50% 50%',
            'background-image': `url(${imageUrl})`, 'background-repeat': 'no-repeat', 'background-size': '69px'});// , 'background-color': '#3873E0'
        },
      });
    };
...
const syncData = (() => {
  const syncAllFormsData = (userId, data) => {
    ...
    const userSelector = $(`.ep_profile_user_row[data-id="user_list_${userId}"]`);
    if (userSelector.length) {
      const usernameBox = userSelector.children('.ep_profile_user_list_profile_userDesc').children('.ep_profile_user_list_username');
      usernameBox.children('.ep_profile_user_list_username_text').text(data.username);

      userSelector.children('.ep_profile_user_list_profile_userDesc').children('.ep_profile_user_list_profile_desc').text(data.about);
      if (data.homepage) {
  ...
  const resetGeneralFields = (userId) => {
    ...
    if (userSelector.length) {
      ...
      userSelector.children('.ep_profile_user_list_profile_userDesc').children('.ep_profile_user_list_profile_desc').text('');
      const homepageElem = usernameBox.children('.ep_profile_contributor_link_container');
