...
exports.expressConfigure = (hookName, context) =>{
    ...
    context.app.get('/:padId/pluginfw/ep_profile_modal/getUserInfo/:userId', async function (req, res, next) {
    ...
    context.app.get('/emailConfirmation/:userId/:padId/:confirmCode', async function (req, res, next) {
    ...
    context.app.get('/getUserProfileImage/:userId/:padId', async function (req, res, next) {
    ...
    context.app.get('/:padId/pluginfw/ep_profile_modal/sendVerificationEmail/:userId/:userName/:email',async function (req, res, next) {
    ...
    context.app.get('/:padId/pluginfw/ep_profile_modal/resetProfileImage/:userId',async function (req, res, next) {
        var padId = req.params.padId;
        var userId = req.params.userId;
    ...
    context.app.post('/:padId/pluginfw/ep_profile_modal/upload/:userId',async function (req, res, next) {
        var padId = req.params.padId;
        var userId = req.params.userId;
